...
#define MBOX_TAG_ARM_MEMORY 0x00010005 // Get ARM memory
#define MBOX_TAG_VC_MEMORY 0x00010006  // Get VC memory
#define MBOX_TAG_SETPHYWH 0x00048003   // Set physical width/height
// Get board clock rate
